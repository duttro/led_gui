...
class Dragged:
    ...
    def dnd_end(self,Target,Event):
        ...
        if self.Canvas==None and self.OriginalCanvas<>None:
            ...
            self.Button['image'] = PhotoImage(file = self.ObjectDict[Source.Name][2])
            print("Exsisting button dropped reload image from dict  image file path = %s"%(self.ObjectDict[Source.Name][2]))
        ...
        if self.OriginalCanvas:
            ...
            self.Original_image_filepath = None
    ...
    def Press(self,Event):
        ...
        #self.Original_image_filepath = self.image_filepath;
        #print("Dragged.press image file path = %s"%(self.image_filepath))
        self.Original_image_filepath = ((CanvasDnd.ObjectDict[Source.Name][2]));
        print("Dragged.press image file path = %s"%(CanvasDnd.ObjectDict[Source.Name][2]))
