...
## 062414 modifing code to kill the serial thread, seems to work on the esc key but not the other methods yet
...
class Assembly:
    def __init__(self,win, tx_queue):
        ...
        Frame1 = Tkinter.Frame(win,  width=1000, height= 200, bg="red")
        Frame1.grid(row = 0, column = 0) 
        
        Frame2 = Tkinter.Frame(win,  width=1000, height= 200, bg="blue")
        Frame2.grid(row = 1, column = 0)
        
        Frame3 = Tkinter.Frame(win,  width=1000, height= 200, bg="green")
