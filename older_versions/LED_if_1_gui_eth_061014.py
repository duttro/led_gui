...
class GuiPart:
    ...
    def __init__(self,win, tx_queue):
        ...
        self.b0 = bytearray(97)
        self.b1 = bytearray(97)
        self.b2 = bytearray(97)
        self.b3 = bytearray(97)
        self.b4 = bytearray(97)
        self.b5 = bytearray(97)
        self.b6 = bytearray(97)
        self.b7 = bytearray(97)
    ...
    def cb_image0(self):
        ...
        #self.send_full_matrix(self.screenMatrix[0])
        self.q.put(self.b0)
    def cb_image1(self):
        # send the full image to the display all in one message
        self.send_full_matrix(self.screenmatrix[1])
    def cb_image2(self):
        # send the full image to the display all in one message
        self.send_full_matrix(self.screenmatrix[2])
    def cb_image3(self):
        # send the full image to the display all in one message
        self.send_full_matrix(self.screenmatrix[3])
    def cb_image4(self):
        # send the full image to the display all in one message
        self.send_full_matrix(self.screenmatrix[4])
    def cb_image5(self):
        # send the full image to the display all in one message
        self.send_full_matrix(self.screenmatrix[5])
    def cb_image6(self):
        # send the full image to the display all in one message
        self.send_full_matrix(self.screenmatrix[6])
    def cb_image7(self):
        # send the full image to the display all in one message
        self.send_full_matrix(self.screenmatrix[7])
    ...
    def load_GIF(self):
        ...
        for i in gifMatrix:
          m=m+i
        tempBuffer = bytearray('F'.encode("hex") + ''.join(m).replace('#',''))
    ...
    def send_full_matrix(self,matrix):
        self.q.put(self.matrix) # write the whole matrix to the tx buffer
