...
class Assembly_TAB:
    def __init__(self,win, tx_queue):
      ...
      def on_dnd_start(Event):
        ...
        print("PASSING image file path to DRAGGED = %s"%(self.image_filepath))
        ThingToDrag = dnd.Dragged(self.image_filepath)
      ...
      def get_image_filepath():
        self.image_filepath = tkFileDialog.askopenfilename(filetypes=[("Image Files","*.gif"),("GIF",'*.gif')] )
        print("ASSEMBLY image file path = %s"%(self.image_filepath))
      
      #Create a button to select the next buttons image file 
