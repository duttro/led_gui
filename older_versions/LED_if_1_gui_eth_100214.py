...
class Assembly_TAB:
    ...
    def __init__(self,win, tx_queue):    
      ...
      def on_dnd_start(Event):
        ...
        print("PASSING image file path to CANVAS DND = %s"%(dnd.Dragged.image_filepath))
      ...
      def get_image_filepath():
        dnd.Dragged.image_filepath = tkFileDialog.askopenfilename(filetypes=[("Image Files","*.gif"),("GIF",'*.gif')] )
        print("ASSEMBLY image file path = %s"%(dnd.Dragged.image_filepath))
